                            ...
                            <div class="slides">
                                <div id="slides__1" class="slide">
                                    <span class="slide__text">
                                        <div class="img-slider-1"></div>
                                        <div class="img-slider-2"></div>
                                ...
                                <div id="slides__2" class="slide">
                                    <span class="slide__text">
                                        <div class="img-slider-3"></div>
                                        <div class="img-slider-4"></div>
...
.slide__text {
    ...
    .img-slider-2 {
        height: 400px;
        width: 300px;
        background-image: url('@/immagini/cookies-with-ice-cream-1200x1530.jpg');
        background-size: cover;
    }
    .img-slider-3 {
        height: 400px;
        width: 300px;
        background-image: url('@/immagini/glazed-pancake-with-lemon-1200x1530.jpg');
        background-size: cover;
    }
    .img-slider-4 {
        height: 400px;
...
.tell {
    background-image: url('@/immagini/bakery-process-1.jpg');
    background-size: cover;
    position: relative;
    height: 400px;
    margin-top: 100px;
...
.grande-cinque {
    ...
    .cinque-l {
        color: white;
        background-image: url('@/immagini/bakery-process-2.jpg');
        position: relative;
        background-size: cover;
        height: 70vh;
        width: 48%;
    ...
    .cinque-r {
        ...
        align-items: center;
        gap: 20px;
        background-color: rgba(248,241,242,255);
        p {
            font-size: 10px;
            color: rgba(152,149,172,255);
        }
